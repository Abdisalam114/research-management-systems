...
const MENU = [
  { to: "/dashboard", label: "Dashboard", icon: "🏠", roles: [...SYSTEM_ROLES] },
  { to: "/projects", label: "Projects", icon: "📁", roles: ["research_director", "faculty_coordinator", "researcher"] },
  { to: "/research-workflow", label: "Workflow", icon: "🔄", roles: ["research_director", "faculty_coordinator", "researcher"] },
  ...
  { to: "/committee-assignments", label: "Committee", icon: "⚖️", roles: ["research_director", "faculty_coordinator"] },
  { to: "/finance/reviews", label: "Finance review", icon: "🧮", roles: ["finance_officer"] },
  { to: "/finance/grant-approvals", label: "Grant approval", icon: "💵", roles: ["finance_officer"] },
  { to: "/finance/closures", label: "Closures", icon: "📁", roles: ["finance_officer"] },
  ...
  { to: "/policies", label: "Policies", icon: "📜", roles: [...SYSTEM_ROLES] },
  ...
  { to: "/system-reports", label: "Reports", icon: "📑", roles: ["research_director", "faculty_coordinator", "finance_officer", "leadership"] },
  { to: "/finance-reports", label: "Finance Reports", icon: "📊", roles: ["research_director", "finance_officer"] },
  { to: "/kpi-dashboard", label: "KPI", icon: "📈", roles: ["research_director", "faculty_coordinator", "leadership"] },
  ...
  { to: "/messages", label: "Messages", icon: "💬", roles: [...MESSAGE_ROLES] },

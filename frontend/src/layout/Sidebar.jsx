...
const MENU = [
  ...
  { to: "/funding-calls", label: "Funding Calls", icon: "📢", roles: ["research_director", "faculty_coordinator", "finance_officer", "researcher", "leadership", "donor_agency"] },
  { to: "/policies", label: "Policies (Siyaasada)", icon: "📜", roles: [...SYSTEM_ROLES] },
  { to: "/grants", label: "Grants", icon: "💰", roles: ["research_director", "faculty_coordinator", "finance_officer", "researcher", "leadership", "donor_agency"] },

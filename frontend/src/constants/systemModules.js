...
export const SYSTEM_MODULES = [
  ...
  { key: "funding_calls", to: "/funding-calls", label: "Funding Calls", icon: "📢", roles: ["research_director", "faculty_coordinator", "finance_officer", "researcher", "leadership", "donor_agency"] },
  { key: "policies", to: "/policies", label: "Policies", icon: "📜", roles: [...SYSTEM_ROLES] },
  { key: "grants", to: "/grants", label: "Grants", icon: "💰", roles: ["research_director", "faculty_coordinator", "finance_officer", "researcher", "leadership", "donor_agency"] },

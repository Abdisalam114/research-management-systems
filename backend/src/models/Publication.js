...
const publicationSchema = new mongoose.Schema(
  {
    ...
    publishPlatform: { type: String, default: "", trim: true, index: true },
    ...
    citationsRefreshedAt: { type: Date, default: null },
    citationsSource: { type: String, enum: ["crossref", "manual"], default: null },

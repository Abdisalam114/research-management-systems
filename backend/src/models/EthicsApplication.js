...
const ethicsSchema = new mongoose.Schema(
  {
    ...
    approval: {
      ...
      chairpersonLine: { type: String, default: "" },
      signatoryKey: { type: String, default: "joint" },
      signatoryTitle: { type: String, default: "Chairperson" },
      includeSignature: { type: Boolean, default: true },
      includeStamp: { type: Boolean, default: true },
      displayPrincipalInvestigator: { type: String, default: "" },
      displayFacultyCenter: { type: String, default: "" },
      displayProjectTitle: { type: String, default: "" },

...
const ROLES = [
  ...
  ["Faculty Coordinator", "faculty_coordinator", "Faculty proposal pre-review, publication validation, faculty reports"],
  ["Finance Officer", "finance_officer", "Budgets, payment disbursement, procurement, finance reports"],
  ["Researcher", "researcher", "Proposals, ethics forms, projects, publications, groups, repository uploads"],
];
...
const FRONTEND_PAGES = [
  ...
  ["/proposals/new", "New Proposal + Ethics", "Researcher only"],
  ...
  ["/thesis", "Thesis Groups", "Director, Coordinator, Researcher"],
  ["/grants", "Grants", "All except standalone coordinator-only"],
  ["/budgets", "Finance & Budgets", "Director, Finance, Researcher"],
...
const DEMO_LOGINS = [
  ...
  ["Researcher", "asha@rms.edu", "Researcher2024!"],
  ["Researcher", "mahad@rms.edu", "Researcher2024!"],
];
...
async function generatePdf() {
  ...
  // 8. Demo logins
  sectionTitle(doc, "8. Demo Accounts (after npm run seed)");
  renderTable(doc, [["Role", "Email", "Password"], ...DEMO_LOGINS], [120, 160, contentW - 280]);
  drawHr(doc);
